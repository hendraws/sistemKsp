			...
			<div class="card-body">
				<div class="tab-content" id="custom-tabs-one-tabContent">
					<div class="tab-pane fade show <?php echo $tab_aktif1;?>" id="pembukuan-harian" role="tabpanel" aria-labelledby="pembukuan-harian-tab">
						...
						<?php
						if(!empty($cabang)){
							$qpenunjuk       = mysqli_query($con,"SELECT pembukuan_tgl FROM tbl_pembukuan_harian 
								LEFT JOIN tbl_resort ON tbl_resort.resort_id=tbl_pembukuan_harian.resort_id   
								WHERE pembukuan_tgl LIKE '$bulan%' AND tbl_resort.unit_id = '$cabang' 
								GROUP BY pembukuan_tgl ORDER BY pembukuan_tgl ASC");
						}else{
							$qpenunjuk       = mysqli_query($con,"SELECT pembukuan_tgl FROM tbl_pembukuan_harian 
								LEFT JOIN tbl_resort ON tbl_resort.resort_id=tbl_pembukuan_harian.resort_id   
								WHERE pembukuan_tgl LIKE '$bulan%' 
								GROUP BY pembukuan_tgl ORDER BY pembukuan_tgl ASC");
						}					
						...
						<div class="timeline" >
							...
							if(!empty($cabang)){
								$q11       = mysqli_query($con,"SELECT pembukuan_tgl from tbl_pembukuan_harian 
									LEFT JOIN tbl_resort ON tbl_resort.resort_id=tbl_pembukuan_harian.resort_id   
									where pembukuan_tgl like '$bulan%' AND tbl_resort.unit_id = '$cabang' 
									group by pembukuan_tgl 
									order by pembukuan_tgl asc");
							}
										...
										<div class="timeline-body">
											<table  class="table table-bordered table-hover table-striped" style="width:100%">
												...
												<tbody>
													...
													if(!empty($cabang)){
														$q1       = mysqli_query($con,"SELECT a.*,b.resort_nama,b.unit_id FROM tbl_pembukuan_harian a 
															LEFT JOIN tbl_resort b ON a.resort_id=b.resort_id  
															WHERE a.pembukuan_tgl = '$pembukuan_tgl_loop' AND b.unit_id = '$cabang'") or die(mysqli_error($con));
													}else{
														$q1       = mysqli_query($con,"SELECT a.*,b.resort_nama,b.unit_id FROM tbl_pembukuan_harian a 
															LEFT JOIN tbl_resort b ON a.resort_id=b.resort_id  
															WHERE a.pembukuan_tgl = '$pembukuan_tgl_loop'") or die(mysqli_error($con));
													}
						...
						<table id="--example2" class="table table-bordered table-hover table-striped" style="width:100%">
							...
							<tbody>
								...
								for($x=0;$x<$jum;$x++){
									...
									$q2       = mysqli_query($con,"SELECT * from tbl_akomodasi 
										where akomodasi_tgl = '$pembukuan_tgl_loop' 
										order by akomodasi_tgl asc");
									if(!empty($cabang)){
										$q2       = mysqli_query($con,"SELECT * from tbl_akomodasi 
											where akomodasi_tgl = '$pembukuan_tgl_loop' AND cabang = '$cabang' 
											order by akomodasi_tgl asc");
									}
										...
										<div class="timeline-body">
											<table id="example3" class="table table-bordered table-hover table-striped" style="width:100%">
												...
												<tbody>
													...
													if(!empty($cabang)){
														$q3       = mysqli_query($con,"SELECT a.*,b.pegawai_nama from tbl_bon_panjer a 
															left join tbl_pegawai b on a.pegawai_id=b.pegawai_id where a.panjer_tgl =  '$pembukuan_tgl_loop' AND b.cabang = '$cabang' order by a.panjer_tgl asc");
													}
										...
										<div class="timeline-body">
											<table id="example4" class="table table-bordered table-hover table-striped" style="width:100%">
												...
												<tbody>
													...
													if(!empty($cabang)){
														$q4       = mysqli_query($con,"SELECT a.*,b.pegawai_nama from tbl_bon_prive a 
															left join tbl_pegawai b on a.pegawai_id=b.pegawai_id where a.prive_tgl =  '$pembukuan_tgl_loop' AND b.cabang = '$cabang' order by a.prive_tgl asc");
													}
										...
										<div class="timeline-body">
											<table id="example5" class="table table-bordered table-hover table-striped" style="width:100%">
												...
												<tbody>
													...
													if(!empty($cabang)){
														$q5       = mysqli_query($con,"SELECT a.*,b.bu_nama from tbl_operasional a left join tbl_biayaumum b on a.bu_id=b.bu_id where a.operasional_tgl = '$pembukuan_tgl_loop' and b.bu_kategori='0' and a.cabang = '$cabang' order by a.operasional_tgl asc");
									...
									<div class="timeline-body">
										<table id="example5" class="table table-bordered table-hover table-striped" style="width:100%">
											...
											<tbody>
												...
												if(!empty($cabang)){
													$q5       = mysqli_query($con,"SELECT a.*,b.bu_nama from tbl_operasional a left join tbl_biayaumum b on a.bu_id=b.bu_id where a.operasional_tgl = '$pembukuan_tgl_loop' and b.bu_kategori='1' AND a.cabang = '$cabang' order by a.operasional_tgl asc");
				...
				for($x=0;$x<$jum_tgl;$x++){
					...
					<table  class="table table-bordered table-hover table-striped" style="width:100%" id="f<?php echo $pembukuan_tgl_loop;?>">
						...
						<tbody>
							...
							if(!empty($cabang)){
								$q1       = mysqli_query($con,"SELECT a.*,b.resort_nama from tbl_pembukuan_harian a 
									join tbl_resort b on a.resort_id=b.resort_id 
									where a.pembukuan_tgl = '$pembukuan_tgl_loop' AND where b.cabang = '$cabang'");
							}
							while($h1   = mysqli_fetch_array($q1,MYSQLI_ASSOC)){
								$pembukuan_id    = $h1['pembukuan_id'];
								$drop_arr[]       = $h1['pembukuan_drop'];
          	...
          	<table  class="table table-bordered table-hover table-striped" style="width:100%">
          		...
          		<tbody>
          			...
          			for($x=0;$x<$jum_tgl;$x++){
          				...
          				$exp14 = $kasMasuk['total_kas_masuk'];
          				...
          				<tr class="small">
          					...
          					<td align="right"><?php echo str_replace(",", ".", number_format($exp14));?></td>
