							...
							<table id="example1" class="table table-bordered table-hover table-striped" style="width:100%">
								...
								<tbody>
									...
									while($h1   = mysqli_fetch_array($q1,MYSQLI_ASSOC)){
										...
										$qmacet = mysqli_query($con,"select * from tbl_kemacetan where bulan='$bulan' and resort_id='$resort_id' and cabang='$cabang'");
										$cek=mysqli_num_rows($qmacet);
										if($cek==0){
											mysqli_query($con,"insert into tbl_kemacetan(kemacetan_baru,angsuran,plus,minus,bulan,resort_id,minggu,cabang) values('0','0','0','0','$bulan','$resort_id','1','$cabang')");
											mysqli_query($con,"insert into tbl_kemacetan(kemacetan_baru,angsuran,plus,minus,bulan,resort_id,minggu,cabang) values('0','0','0','0','$bulan','$resort_id','2','$cabang')");
											mysqli_query($con,"insert into tbl_kemacetan(kemacetan_baru,angsuran,plus,minus,bulan,resort_id,minggu,cabang) values('0','0','0','0','$bulan','$resort_id','3','$cabang')");
										}else{
