					...
					<div class="col-md-12">
						...
						<table id="example1" class="table table-bordered table-hover" style="width:100%">
							...
							<tbody>
								<?php 
                        //aktif
								$q2   = mysqli_query($con,"SELECT anggota_id,anggota_nama,anggota_alamat,tgl_daftar,keterangan,pinjaman_awal,simpanan_awal,unit_id from tbl_anggota join tbl_resort ON tbl_resort.resort_id = tbl_anggota.resort_id where tbl_anggota.resort_id = '$resort_id' and tbl_resort.unit_id = '$cabang'") or die(mysqli_error($con));
