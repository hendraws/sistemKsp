                ...
                <div class="row">
                  <div class="col-md-12">
				   ...
				   $pemisah = 1;
                        ...
                        $q1       = mysqli_query($con,"SELECT b.resort_id,b.resort_nama from tbl_pembukuan_harian a join tbl_resort b on a.resort_id=b.resort_id where pembukuan_tgl like '$bulan%' and b.unit_id='$unit_id' GROUP BY b.resort_id,b.resort_nama ORDER BY b.resort_id asc");
