            ...
            <td align="center">
             ...
             <td align="center">
                Lain.
                        ...
                        <?php 
                        $no=1;
                        $q    = mysqli_query($con,"select a.pegawai_id,a.pegawai_nik,a.pegawai_nama,b.jabatan_nama,a.jabatan_id,a.pegawai_jk from tbl_pegawai a left join tbl_jabatan b on a.jabatan_id=b.jabatan_id where a.pegawai_id!='admin' and a.jabatan_id!='14' order by a.jabatan_id asc");
