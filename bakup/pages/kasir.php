  ...
  if(isset($_POST['tambah_akomodasi'])){
    ...
    $akomodasi_tgl                = $_POST['akomodasi_tgl'];
        ...
        if($akomodasi_id!=""){
          ...
          //$pegawai_id = date("Ymdhis");
          $qcek = mysqli_query($con,"select akomodasi_id from tbl_akomodasi where akomodasi_tgl='$akomodasi_tgl'");
          $cek = mysqli_num_rows($qcek);
          if($cek>0){
            ?>
            <script type="text/javascript">
          ...
          $up=mysqli_query($con,"insert into tbl_akomodasi (uang_makan,uang_transport,akomodasi_tgl,akomodasi_id) values('$uang_makan','$uang_transport','$akomodasi_tgl','$akomodasi_id')");
          if($up){
            ?>
            <script type="text/javascript">
              toastr.success('Tambah data berhasil disimpan');
  ...
  if(isset($_POST['tambah_bon_panjer'])){
    ...
    $pegawai_id               = $_POST['pegawai_id'];
        ...
        if($panjer_id!=""){
          ...
          $up=mysqli_query($con,"insert into tbl_bon_panjer (panjer_id,panjer_tgl,panjer_nominal,panjer_ket,pegawai_id) values('$panjer_id','$panjer_tgl','$panjer_nominal','$panjer_ket','$pegawai_id')");
          if($up){
            ?>
            <script type="text/javascript">
              toastr.success('Tambah data berhasil disimpan');
  ...
  if(isset($_POST['tambah_operasional'])){
    ...
    $bu_id               = $_POST['bu_id'];
        ...
        if($operasional_id!=""){
          ...
          $up=mysqli_query($con,"insert into tbl_operasional (operasional_id,bu_id,nominal,operasional_ket,operasional_tgl) values('$operasional_id','$bu_id','$nominal','$operasional_ket','$operasional_tgl')");
          if($up){
            ?>
            <script type="text/javascript">
              toastr.success('Tambah data berhasil disimpan');
