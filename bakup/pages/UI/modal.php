...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
         <li class="nav-item">
       <img src="https://simpeg.ump.ac.id/foto/2160703.jpg"
           alt="Logo"
           class="brand-image img-circle elevation-3"
           ><label>(2160703) Slamet Widodo</label>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
              ...
              <object data="https://simpeg.ump.ac.id/index.php?adm=1" type="text/html"  style="width:100%;height:100vh;">
   </object>
