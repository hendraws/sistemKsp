...
include 	"../lib/koneksi.php";
	//total inven
	$q		= mysqli_query($con,"select a.*,b.pegawai_nama,c.unit_nama from tbl_resort a left join tbl_pegawai b on a.pegawai_id=b.pegawai_id left join tbl_unit c on a.unit_id=c.unit_id");
