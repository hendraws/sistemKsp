                          ...
                          <tr>
                            ...
                            <td>
                              <select name="pegawai_id" class="form-control" style="width: 100%" id="keterangan">
                                <option value=""></option>
                                <?php
                                $qpeg = mysqli_query($con,"select pegawai_id,pegawai_nama from tbl_pegawai where jabatan_id='4' or jabatan_id='6'");
                                while($hpeg=mysqli_fetch_array($qpeg)){
                                  $pegawai_idne = $hpeg['pegawai_id'];
                                  if($pegawai_id==$pegawai_idne){
                                    $pilih = "selected";
                       ...
                       <form method="POST" action="/proses_gaji">
                        ...
                        <table class="table">
                          <tr>
                            <td>Gaji Pokok</td>
                            <td>
                              <input type="number" name="gaji_pokok" class="form-control" value="<?php echo $gaji_pokok;?>" readonly>
                            </td>
                          </tr>
                          <tr>
                        ...
                        <form method="POST" action="/kasir" onsubmit="return confirm('Yakin data sudah benar?')">
                          ...
                          <table class="table">
                            ...
                            <tr>
                              ...
                              <td>
                                <select name="pegawai_id" class="form-control" style="width: 50%" required>
